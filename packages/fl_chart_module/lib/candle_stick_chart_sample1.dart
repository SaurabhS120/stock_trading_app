...
import 'package:fl_chart_module/app_colors.dart';
import 'package:fl_chart_module/csv_parser.dart';
...
class CandlestickChartSample1State extends State<CandlestickChartSample1> {
  ...
  void _loadData() async {
    final data = await rootBundle
        .loadString(
        'packages/fl_chart_module/assets/data/bitcoin_2023-01-01_2023-12-31.csv');
